...
export const faqs: FaqType[] = [
  ...
  {
    question: "Can I request a book to be added?",
    answer:
  ...
  {
    question: "Why are there spelling/grammatical errors in the books?",
    answer:
  ...
  {
    question: "Can I pick which chapter I want to type?",
    answer:
  ...
  {
    question: "Can I type books in a language other than English?",
    answer:
      "At this time only English books are supported. Automatically translating the page will break the typing test.",
  },
  {
    question: "I got pulled away from my keyboard. Will this impact my score",
    answer:
